...
router.post('/cart/products', async (req, res) => {
    //figure out the cart - do we have a cart for this user or we need to create one.
    let cart;
    if (!req.session.cartId) {
        //we do not have a cart, we need to create one and store it on req.session.cardId property
